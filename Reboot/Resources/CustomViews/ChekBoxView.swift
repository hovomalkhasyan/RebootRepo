...
open class CheckboxButton: UIControl {
    // MARK: Public properties
     let separatotColor = UIColor(red: 193.0 / 255.0, green: 193.0 / 255.0, blue: 193.0 / 255.0, alpha: 1)
     let appMainColor = UIColor(red: 223.0 / 255.0, green: 0, blue: 38.0 / 255.0, alpha: 1)
    let chackColor = UIColor(red: 255.0 / 255.0, green: 66.0 / 255.0, blue: 30.0 / 255.0, alpha: 0.5)
    let chackColorOn = UIColor(red: 255.0 / 255.0, green: 66.0 / 255.0, blue: 30.0 / 255.0, alpha: 1)
    ...
    @IBInspectable open var checkColor: UIColor = UIColor.white {
        didSet {
            colorLayers()
        }
    }
    ...
    internal var containerPath: UIBezierPath {
        if circular {
            ...
            return UIBezierPath(roundedRect: containerFrame, cornerRadius: 1)
        }
    }
    ...
    fileprivate func layoutLayers() {
        ...
        containerLayer.cornerRadius = 30.0
    ...
    fileprivate func colorLayers() {
        containerLayer.strokeColor = chackColor.cgColor
        containerLayer.fillColor = UIColor.red.cgColor
        checkLayer.strokeColor = UIColor.red.cgColor


        if on {
            containerLayer.fillColor = chackColorOn.cgColor
            checkLayer.strokeColor = checkColor.cgColor
            containerLayer.strokeColor = chackColorOn.cgColor
            layer.addSublayer(checkLayer)
        } else {
            containerLayer.fillColor = UIColor.clear.cgColor
            checkLayer.strokeColor = chackColor.cgColor
        }
    }
